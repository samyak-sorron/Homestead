...
// import { div, div, Heading, p } from 'tailwindcss-react-kit';
...
const PropertyDetail = () => {
  ...
  return (
    ...
    <div >
    <div className="my-8 border-2 rounded-md float-right" style={{"width":"40vh"}}>
      <div className="text-center">
        ...
        <p className="mt-4">Unlimited Storage</p>
        <p>25GB Bandwidth</p>
        <p>10 Databases</p>
        <p>500 GB SSD Disk</p>
